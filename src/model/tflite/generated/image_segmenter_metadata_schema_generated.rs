...
impl<'a> ImageSegmenterOptions<'a> {
  ...
  pub fn activation(&self) -> Activation {
    ...
    unsafe { self._tab.get::<Activation>(ImageSegmenterOptions::VT_ACTIVATION, Some(Activation::NONE)).unwrap()}
  }
  #[inline]
  pub fn min_parser_version(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageSegmenterOptions::VT_MIN_PARSER_VERSION, None)}
  }
}
...
impl<'a: 'b, 'b> ImageSegmenterOptionsBuilder<'a, 'b> {
  ...
  pub fn add_activation(&mut self, activation: Activation) {
    self.fbb_.push_slot::<Activation>(ImageSegmenterOptions::VT_ACTIVATION, activation, Activation::NONE);
  }
  #[inline]
  pub fn add_min_parser_version(&mut self, min_parser_version: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ImageSegmenterOptions::VT_MIN_PARSER_VERSION, min_parser_version);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ImageSegmenterOptionsBuilder<'a, 'b> {
...
pub fn root_as_image_segmenter_options(buf: &[u8]) -> Result<ImageSegmenterOptions, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_image_segmenter_options(buf: &[u8]) -> Result<ImageSegmenterOptions, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_image_segmenter_options_unchecked(buf: &[u8]) -> ImageSegmenterOptions {
...
pub unsafe fn size_prefixed_root_as_image_segmenter_options_unchecked(buf: &[u8]) -> ImageSegmenterOptions {
...
#[inline]
pub fn finish_size_prefixed_image_segmenter_options_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<ImageSegmenterOptions<'a>>) {
